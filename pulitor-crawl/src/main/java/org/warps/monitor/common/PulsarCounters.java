...
import static org.warps.pulsar.common.PulsarConstants.STAT_PULSAR_STATUS;

/**
 * TODO : use metrics module, for example, http://metrics.dropwizard.io
 * */
public class PulsarCounters {

  public static Logger LOG = LoggerFactory.getLogger(PulsarCounters.class);
